...
def content_extractor(coin_name):
    ...
    url = f"https://sg.finance.yahoo.com/quote/{symbols[coin_name]}-INR/history?period1={unixtime-86400*10}&period2={unixtime}&interval=1d&filter=history&frequency=1d&includeAdjustedClose=true"
    print(url)
    try:
...
print(content_extractor("bitcoin"))
